...
# finetuned head.
#
# NO AUTO-RESUBMIT (unlike jobs/pretrain/encoder_pretraining.sh): Trainer runs
...
#
# Usage:
#   sbatch jobs/finetune/encoder.sh --checkpoint checkpoints/encoder_pretrain/final.pt \
