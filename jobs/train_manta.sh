...
# Usage: sbatch jobs/train_manta.sh --data-source all --langs all --max-steps 20000 --vocab-size 50000
...
if [ $? -eq 0 ]; then
    ...
    sbatch jobs/evaluate.sh manta --checkpoint "$CHECKPOINT_PATH" --eval-data-source bouquet_test \
