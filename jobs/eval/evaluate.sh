...
#
# Usage: sbatch jobs/eval/evaluate.sh fairtok --checkpoint checkpoints/policy_12345.pt
#   sbatch jobs/eval/evaluate.sh magnet --checkpoint checkpoints/magnet_12345.pt --num-groups 50
