...
# jobs/eval/pretrained.sh's own structure for the decoder's eval suite.
...
# prepared locally FIRST (see jobs/prep/bible_nlp.sh) -- common.data.
# corpora.stream_groups("bible_nlp", ...) has no live-streaming fallback.
#
# Usage:
#   sbatch jobs/eval/encoder.sh --checkpoint checkpoints/encoder_pretrain/final.pt \
