...
# confirmed this org's actual rate limit is 100/min (configs/eval/claude.yml
...
#
# Usage:
#   sbatch jobs/eval/claude.sh -c configs/eval/claude.yml
#   sbatch jobs/eval/claude.sh --model claude-opus-5 --eval-data-source bouquet_test --rpm 2000 \
...
# Preflight: fail fast if quota's already maxed out -- see jobs/prep/pretraining_data.sh.
