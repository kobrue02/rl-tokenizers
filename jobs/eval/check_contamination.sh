...
# local disk cache jobs/prep/pretraining_data.sh needs (jobs/prep/glot500.sh
...
#
# NO RESUME: unlike jobs/pretrain/pretraining.sh/jobs/prep/pretraining_data.sh, the
...
# string as glot500's own Swahili file. Once jobs/prep/glot500.sh has
...
#   sbatch jobs/eval/check_contamination.sh \
...
# jobs/prep/glot500.sh/jobs/prep/pretraining_data.sh's own comments on
