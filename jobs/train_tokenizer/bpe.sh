...
# Usage: sbatch jobs/train_tokenizer/bpe.sh --data-source all --langs all --vocab-size 50000
...
if [ $? -eq 0 ]; then
    ...
    sbatch jobs/eval/evaluate.sh bpe --checkpoint "$CHECKPOINT_PATH" --eval-data-source bouquet_test \
