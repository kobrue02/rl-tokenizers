...
# Usage: sbatch jobs/train_tokenizer/superbpe.sh --data-source all --langs all --vocab-size 50000
...
if [ $? -eq 0 ]; then
    ...
    sbatch jobs/eval/evaluate.sh superbpe --checkpoint "$CHECKPOINT_PATH" --eval-data-source bouquet_test \
