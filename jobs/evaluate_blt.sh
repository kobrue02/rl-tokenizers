...
#
# Usage:
#   sbatch jobs/evaluate_blt.sh -c configs/eval_blt.yml
#   sbatch jobs/evaluate_blt.sh --eval-data-source bouquet_test \
...
#   sbatch jobs/evaluate_blt.sh --eval-data-source bouquet_test --num-groups 20 \
