...
# bible_nlp.sh: resumable per-language and auto-resubmitting (~308GB
...
#
# Usage:
#   sbatch jobs/prep/glot500.sh --output-dir "$WORK_ROOT/data/glot500" --limit 5 --max-workers 4  # smoke test first
#   sbatch jobs/prep/glot500.sh --output-dir "$WORK_ROOT/data/glot500" --max-workers 8             # full run
