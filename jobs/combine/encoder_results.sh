...
# jobs/combine/combine_and_generate_figures.sh's own role for the tokenizer-eval
# side. Usually the final step of jobs/eval/run_encoder_eval_suite.sh's
# dependency chain, but safe to run directly any time:
#   sbatch jobs/combine/encoder_results.sh
